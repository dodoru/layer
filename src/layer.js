...
!function (window, undefined) {
    "use strict";
    var layer_css_file = 'skin/layer.css'; // layer.css 的相对路径（参照路径为 layer.js）。
    var $, win, ready = {
        getPath: function () {
...
//默认内置方法。
    var layer = {
        ...
        config: function (options, fn) {
            ...
            layer.use(layer_css_file, (options.extend && options.extend.length > 0) ? (function loop() {
